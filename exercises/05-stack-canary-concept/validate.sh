#!/usr/bin/env bash
#
# validate.sh for module 05 — Stack Canary — Concept & Defeat Conditions
...
echo "============================================================"
echo " Validating module 05: Stack Canary — Concept & Defeat Conditions"
echo " Expected protection profile: canary-only"
echo "============================================================"
...
echo "  - Does the checksec output above match the 'canary-only' profile"
