#!/usr/bin/env bash
#
# validate.sh for module 10 — Heap Overflow — Function Pointer Overwrite
...
echo "============================================================"
echo " Validating module 10: Heap Overflow — Function Pointer Overwrite"
echo " Expected protection profile: full"
echo "============================================================"
...
echo "  - Does the checksec output above match the 'full' profile"
